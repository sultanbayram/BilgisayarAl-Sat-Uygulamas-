                ...
                if (snapshot!=null){
                    if (!snapshot.isEmpty){
                        ...
                        for (document in documents){
                            ...
                            val indirilenPost=Post(id, cozunurlugu,durumu, ekranboyutu, fiyati, gorselUrl, ilanaciklamasi, ilanbaslik, islemci, kullaniciEmail,
                                marka, modeli, pcyili, ram,telefon)
