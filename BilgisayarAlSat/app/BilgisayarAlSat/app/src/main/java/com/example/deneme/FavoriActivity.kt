...
class FavoriActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        /*database.collection("Favori")
            .whereEqualTo("kullanici", email)
            .get()
            .addOnSuccessListener { result ->
                for (document in result) {
                    var deger = document.get("postID").toString()
                    favoriList.add(deger)
        ...
        /* FirebaseFirestore.getInstance().collection("Favori")
              .whereEqualTo("kullanici", email)
    ...
    private fun verileriAl() {
        ...
        database.collection("Post").document("2SJFMMFv1W013hJjieJ0")
                .get()
